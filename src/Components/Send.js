  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-white">
        {/*Balance */}
        <div onClick={() => App.setShowErc(App.showErc ? false : true)} className="flex w-4/5 justify-around items-center mt-7">
        ...
        <div className={`${App.showErc ? '' : "hidden"} flex w-4/5 justify-between items-center mt-5`}>
          <input onChange={(e) => { App.setercTokenAdd(e.target.value) }} value={App.ercTokenAdd} className="w-3/4 p-3 bg-black border-2 border-blue-900 border-opacity-60 bg-opacity-70 outline-none rounded-lg" placeholder="Paste ERC20 Token Address" />
          {App.ercload ?

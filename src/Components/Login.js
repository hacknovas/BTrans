        ...
        <>
            <div className='min-w-full h-4/5 flex justify-center flex-col items-center '>
                <div className="w-1/3 h-40 mt-4  shadow-lg p-3 mb-5 bg-body-none rounded flex flex-col justify-center items-center">
                    <h1 className='badge border-bottom border-top text-white text-2xl mb-3 font-medium text-center'>Login</h1>
                    {
                        ethereum != undefined ?
                            <div onClick={loginwallet} className='flex border-bottom text-lg font-medium  cursor-pointer  text-white mt-4 bg-primary rounded-sm justify-center items-center py-1 px-2'>
                ...
                <div className={`${error ? "" : "hidden"} `}>
                    <div id="toast-simple" className="align-bottom bottom-5 flex  max-w-xs p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
                        ...
                        <div className="btn btn-sm ml-0" onClick={() => {
                            seterror("")
                        }}>
